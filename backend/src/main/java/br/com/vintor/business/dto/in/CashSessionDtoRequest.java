...
public class CashSessionDtoRequest {
    ...
    public CashSessionDtoRequest() {
    }

    public CashSessionDtoRequest(Long id, Instant openingTimestamp, Instant closingTimestamp, BigDecimal openingAmount, BigDecimal closingAmount, BigDecimal expectedAmount, String notes, Boolean closed, UserDtoRequest operator) {
        this.id = id;
