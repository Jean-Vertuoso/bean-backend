...
public class ProductDtoResponse {
    ...
    public ProductDtoResponse(String name, String brand, BigDecimal price, String barCode, String imgUrl, PackagingType packagingType, UnitOfMeasure unitOfMeasure, InventoryDto inventory) {
        this.name = name;
        this.brand = brand;
        this.price = price;
